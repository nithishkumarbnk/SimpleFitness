...
namespace WebApplication1.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public StatisticsController(FitnessDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Metric,Value,Unit")] Statistic statistic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Metric,Value,Unit")] Statistic statistic)
        {
            if (id != statistic.Id)
            {
                return NotFound();
